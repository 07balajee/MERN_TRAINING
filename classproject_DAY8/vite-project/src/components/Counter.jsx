...
//         setcount(count1 => count1-1)//we use function version because we operate on previous count not the currentstate
//     }
...
//     return(
//         <>
//         <button onClick= {decrementCount}className="w-20 h-20 text-4xl">-</button>
//         <span>{count}</span>
//         <button className="w-20 h-20 text-4xl" onClick={incrementCount}>+</button>
//         </>
